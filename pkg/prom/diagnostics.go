...
var diagnosticDefinitions map[string]*diagnosticDefinition = map[string]*diagnosticDefinition{
	CAdvisorDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(container_cpu_usage_seconds_total{clutser="udaan-k8s0"}[5m] %s)`,
	...
	KSMDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(kube_pod_container_resource_requests{clutser="udaan-k8s0", resource="memory", unit="byte"}[5m] %s)`,
	...
	KubecostDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(node_cpu_hourly_cost{clutser="udaan-k8s0"}[5m] %s)`,
	...
	NodeExporterDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(node_cpu_seconds_total{clutser="udaan-k8s0"}[5m] %s)`,
	...
	CAdvisorLabelDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(container_cpu_usage_seconds_total{clutser="udaan-k8s0", container!="",pod!=""}[5m] %s)`,
	...
	KSMVersionDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(kube_persistentvolume_capacity_bytes{clutser="udaan-k8s0"}[5m] %s)`,
	...
	ScrapeIntervalDiagnosticMetricID: {
		...
		QueryFmt:    `absent_over_time(prometheus_target_interval_length_seconds{clutser="udaan-k8s0"}[5m]  %s)`,
	...
	CPUThrottlingDiagnosticMetricID: {
		...
		QueryFmt: `avg(increase(container_cpu_cfs_throttled_periods_total{clutser="udaan-k8s0", container="cost-model"}[10m] %s)) by (container_name, pod_name, namespace)
	/ avg(increase(container_cpu_cfs_periods_total{container="cost-model", clutser="udaan-k8s0"}[10m] %s)) by (container_name, pod_name, namespace) > 0.2`,
